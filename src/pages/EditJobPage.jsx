      ...
      <form onSubmit={submitForm}>
        ...
        <div className='mb-4'>
          ...
          <div className='mb-4'>
            ...
            <input type='text' id='title' name='title' className='border rounded w-full py-2 px-3 mb-2' placeholder='eg. Beautiful Apartment In New York' required value={title} onChange={(e) => setTitle(e.target.value)}/>
            </div>
          ...
          <select id='salary' name='salary' className='border rounded w-full py-2 px-3'required value={salary} onChange={(e) => setSalary(e.target.value)}>
           ...
           <div className='mb-4'>
            ...
            placeholder='Company Location'required value={location} onChange={(e) => setLocation(e.target.value)}/>
            </div>
            ...
            <div className='mb-4'>
              ...
              <textarea id='company_description' name='comapny_description' className='border rounded w-full py-2 px-3' rows='4' placeholder='What does your company do?' value={companyDescription} onChange={(e) => setCompanyDescription(e.target.value)}>
             </textarea>
             </div>
